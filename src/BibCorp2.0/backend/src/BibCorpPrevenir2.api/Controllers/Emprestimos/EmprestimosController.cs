...
namespace BibCorpPrevenir2.api.Controllers.Emrpestimos;
...
public class EmprestimosController : ControllerBase
{
    ...
    [HttpGet("Status")]
    public async Task<IActionResult> GetEmprestimosByStatusAsync([FromQuery] EmprestimoStatus[] status)
    {
        try
        {
    ...
    public async Task<IActionResult> GerenciarEmprestimos(int emprestimoId)
    {
        try
        {
    ...
    [HttpGet("Relatorio")]
    public async Task<IActionResult> GetEmprestimosByFiltrosAsync([FromQuery] EmprestimoFiltroDto filtroEmprestimoDto)
    {
        try
        {
